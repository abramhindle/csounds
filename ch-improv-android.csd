...
idur = p3
ifreq = p4
kfreq = gktrackpadx*4000
a1 foscili gkamp, kfreq, gkslider1, gktrackpady, 1
out a1
endin
...
a1 oscili kenv,p4,gisawtbl,rnd(1)
a3 oscili kbenv*0.20,32768/p4,gisquaretbl,rnd(1)
a2 lowpass2 a1+a3,kfilt,2
;outs a2*(0.17+0.03*kenv),a2*(0.12-0.03*kenv)
;out gkamp*a2*(0.17+0.03*kenv)
out gkamp*a2*(0.17+0.03*kenv)
...
kmod oscili 0.06,20,gisintbl,rnd(1)
a1 oscili kenv*0.25,p4*exp(kmod*kenv*log(2)/12),gisheptbl,rnd(1)
a2 oscili kbenv*0.07,32768/p4,gisawtbl,rnd(1)
...
a1a oscili kenv*0.076,p4*0.996,gisquaretbl,rnd(1)
a1b oscili kenv*0.076,p4,gisquaretbl,rnd(1)
a1c oscili kenv*0.076,p4*1.004,gisquaretbl,rnd(1)
alo oscili kbenv*0.017,32768/p4,gisintbl,rnd(1)
